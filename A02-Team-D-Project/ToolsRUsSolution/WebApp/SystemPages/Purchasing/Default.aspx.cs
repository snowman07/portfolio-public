...
namespace WebApp.SystemPages.Purchasing
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.IsAuthenticated)
            {
                ...
                if (User.IsInRole(ConfigurationManager.AppSettings["departmentHeadRole"]) || User.IsInRole(ConfigurationManager.AppSettings["storeManagerRole"]))
                {
